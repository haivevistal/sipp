            ...
            <form  method="POST" action="<?php echo base_url(); ?>profile/submit_portfolio" enctype="multipart/form-data">
              <div class="mb-3">
                ...
                <div class="accordion" id="submitportfoliopage">
                  ...
                  $exclude = array("seven", "fourteen", "fifthteen");
                  $c = 0; 
                  $portfolio = (array)$portfolio[0];
              ...
              <button type="submit" name="submit_portfolio" class="btn btn-primary" value="save">Submit Portfolio</button>
              <button type="submit" name="generate_pdf" class="btn btn-success" value="pdf">Generate PDF</button>
            </form>
