        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Here you can add new activity</h6>
                </div>
                <div class="card-body">
                    <div class="table-wrapper">
                        <form action="<?= base_url() ?>portal/add_activity" method="POST">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                       ...
                       <div class="form-group">
                                ...
                                <input type="submit" name="save_activity" class="btn btn-success" value="Save">
