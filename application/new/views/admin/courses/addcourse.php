    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Add New Course <?php if($msg) : ?><small><span class="badge badge-success"><?php echo $msg; ?></span></small><?php endif; ?></h2>
                    </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Here you can add new course</h6>
                </div>
                <div class="card-body">
                    <div class="table-wrapper">
                        <form action="<?= base_url() ?>portal/add_course" method="POST">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" name="save_course" class="btn btn-success" value="Save">
