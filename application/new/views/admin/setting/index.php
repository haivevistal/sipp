            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-wrapper">
                        <form action="<?= base_url() ?>portal/setting/" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php if($set->data_type == 'textarea') { ?>
                                            <textarea name="<?php echo $set->code; ?>" class="form-control"><?php echo $set->value; ?></textarea>
                                        <?php } else { ?>
                                            <input type="<?php echo $set->data_type; ?>" name="<?php echo $set->code; ?>" class="form-control" value="<?php echo $set->value; ?>" required />
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } ?>
