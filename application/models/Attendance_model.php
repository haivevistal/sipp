...
class Attendance_model extends CI_Model {
    ...
    public function dtr_lists($student_id)
    {
        $this->db->select('courses.name as course, users.company_id, users.firstname,users.lastname, attendances.*');
        $this->db->join('users', 'users.id = attendances.user_id');
        $this->db->join('courses', 'courses.id = users.course');
