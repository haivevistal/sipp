...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="floating_filters">
            ...
            <label>Start: <input type="date" class="form-control" id="start_date_filter" name="start_date_filter" value="<?php echo $this->uri->segment(4); ?>" /></label>
            <label>End: <input type="date" class="form-control" id="end_date_filter" name="end_date_filter" value="<?php echo $this->uri->segment(5); ?>" /></label>
        ...
        <div class="container-fluid print_content">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h2 class="h3 mb-0 text-gray-800" style="text-align: center;width: 100%;">ISSUES AND CONCERNS IN THE IMPLEMENTATION OF <br/>STUDENT INTERNSHIP PROGRAM IN THE PHILIPPINES(SIPP)<br/>AY <span style="text-decoration: underline;"><?php echo (date("Y")-1)."-".date("Y"); ?></span></h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table width="100%" class="reports_table">
                        ...
                        <?php foreach( $this->setting_model->get_all_seen_feedbacks($this->uri->segment(4),$this->uri->segment(5)) as $feedback ) { ?>
                        <tr>
                            <td width="34%"><span class="txt_before"></span><textarea name="hei" class="report_fields" style="width:100%;border:none !important;"><?php echo $feedback->description; ?></textarea></td>
