            ...
            <div class="row">
                <div class="col-md-12">
                    <table width="100%" class="reports_table">
                        ...
                        <?php foreach( $this->setting_model->get_all_seen_messages($this->uri->segment(4),$this->uri->segment(5)) as $msg ) { ?>
                        <tr>
                            <td width="34%"><span class="txt_before"></span><textarea name="hei" class="report_fields" style="width:100%;border:none !important;"><?php echo $msg->content; ?></textarea></td>
