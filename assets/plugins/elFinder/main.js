...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		load = function() {
			require(
				[
					'/assets/plugins/elFinder/js/elfinder.min.js'
					,'/assets/plugins/elFinder/js/extras/editors.default.min.js'               // load text, image editors
					,'elFinderConfig'
	...
	require.config({
		...
		paths : {
			...
			'elfinder' : '/assets/plugins/elFinder/js/elfinder.min',
